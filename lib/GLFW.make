...
ifeq ($(config),debug)
TARGETDIR = ../binaries/debug/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../binaries/Intermediates/debug/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g

else ifeq ($(config),release)
TARGETDIR = ../binaries/release/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../binaries/Intermediates/release/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC

else ifeq ($(config),dist)
TARGETDIR = ../binaries/dist/GLFW
TARGET = $(TARGETDIR)/libGLFW.a
OBJDIR = ../binaries/Intermediates/dist/GLFW
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -O2 -fPIC
